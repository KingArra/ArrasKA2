                    ...
                    "right"
                            ...
                            if (!B.graphical.screenshotMode) {
                                ...
                                for (let a = 0; a < O.data.length && (!b.mobile || 6 > a); a++) {
                                  ...
                                  if (b.label.includes('e 2'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.yellow, "center", !0);
      ...
      const Sa = (() => {
          ...
          var c = [
            ...
            [
              ...
              "If your a Beta Tester, pressing ` will allow you to access TESTBED!",
              "Begging for Beta-tester will result in a ban."
            ]
          ];
      ...
      const e = {
        ...
        servers: [
                ...
                },
          {
            ...
            at: p.glitch('peppered-shocking-parallelogram'),
                       },
          {
            visible: 0,
            id: "d",
